  ...
  return (
    <div className="space-y-8 text-left max-w-5xl">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 border-b border-white/5 pb-5">
        ...
        {savedSuccess && (
          <div className="flex items-center gap-2 bg-emerald-500/10 border border-emerald-500/30 text-emerald-400 px-4 py-2 rounded-2xl text-xs font-bold shadow-[0_0_15px_rgba(16,185,129,0.2)]">
      ...
      <form onSubmit={handleSubmit} className="space-y-8 text-xs">
        ...
        <div className="bg-cardBg/90 backdrop-blur-sm border border-white/5 p-6 rounded-3xl space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input
                ...
                className="w-full bg-black/40 border border-white/10 rounded-xl px-3.5 py-2.5 text-white placeholder-gray-500 focus:outline-none focus:border-primary text-xs"
              />
            </div>
            ...
            {isBusiness && (
              <>
                <div>
                  <label className="block text-gray-300 font-bold mb-1.5">Legal / Business Entity Name</label>
                  <input
                    type="text"
                ...
                <div className="sm:col-span-2">
                  <label className="block text-gray-300 font-bold mb-1.5">Business Description</label>
                  <textarea
                    rows={3}
                    value={formState.bio || ''}
                ...
                <div>
                  <label className="block text-gray-300 font-bold mb-1.5">Business Category</label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="block text-gray-300 font-bold mb-1.5">GST Number</label>
                  <input
                    type="text"
                    value={formState.gst || ''}
                    onChange={(e) => setFormState({ ...formState, gst: e.target.value })}
                    className="w-full bg-black/40 border border-white/10 rounded-xl px-3.5 py-2.5 text-white placeholder-gray-500 focus:outline-none focus:border-primary text-xs font-mono uppercase"
                  />
                </div>
                <div>
                  <label className="block text-gray-300 font-bold mb-1.5">Store Website</label>
                  <input
                    type="url"
                ...
                <div>
                  <label className="block text-gray-300 font-bold mb-1.5">Social Links (e.g. Instagram)</label>
                  <input
                    type="text"
            ...
            {!isBusiness && (
              <div className="sm:col-span-2">
                <label className="block text-gray-300 font-bold mb-1.5">About Me</label>
                <textarea
                  rows={3}
                  value={formState.bio || ''}
                  onChange={(e) => setFormState({ ...formState, bio: e.target.value })}
            ...
            <div className="sm:col-span-2 grid grid-cols-2 gap-4">
              <div>
                <label className="block text-gray-300 font-bold mb-1.5">Operating City</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-gray-300 font-bold mb-1.5">Operating State</label>
                <input
                  type="text"
        ...
        <div className="bg-cardBg/90 backdrop-blur-sm border border-white/5 p-6 rounded-3xl space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              <label className="block text-gray-300 font-bold mb-1.5">Instant UPI ID</label>
              <input
                type="text"
                value={formState.payoutUPI || ''}
                onChange={(e) => setFormState({ ...formState, payoutUPI: e.target.value })}
                placeholder="aryan@okhdfcbank"
                className="w-full bg-black/40 border border-white/10 rounded-xl px-3.5 py-2.5 text-white placeholder-gray-500 focus:outline-none focus:border-primary text-xs font-mono"
              />
            </div>

            <div>
              <label className="block text-gray-300 font-bold mb-1.5">Bank Name</label>
              <input
                type="text"
            ...
            <div>
              <label className="block text-gray-300 font-bold mb-1.5">Account Number</label>
              <input
                type="text"
            ...
            <div>
              <label className="block text-gray-300 font-bold mb-1.5">IFSC Code</label>
              <input
                type="text"
        ...
        <div className="bg-cardBg/90 backdrop-blur-sm border border-white/5 p-6 rounded-3xl space-y-4">
          ...
          <div className="space-y-3">
            <label className="flex items-center gap-3 p-3 bg-black/30 rounded-2xl border border-white/5 cursor-pointer hover:border-white/10">
              <input
                type="checkbox"
              ...
              />
              <div>
                <span className="font-bold text-white block">Enable Buyer Local Meetup (Handshake)</span>
            ...
            <label className="flex items-center gap-3 p-3 bg-black/30 rounded-2xl border border-white/5 cursor-pointer hover:border-white/10">
              ...
              />
              <div>
                <span className="font-bold text-white block">Instant Order SMS & Email Notifications</span>
                <span className="text-[11px] text-gray-400">
