...
const Register = () => {
  ...
  return (
    <div className="relative min-h-screen w-full bg-[#F8F9FB] dark:bg-[#070B12] text-gray-900 dark:text-white flex flex-col justify-between overflow-x-hidden font-sans select-none transition-colors duration-400">
      ...
      <div className="relative z-10 flex-grow grid grid-cols-1 lg:grid-cols-12 min-h-screen w-full">
        ...
        {/* ================= LEFT SIDE (60% Desktop Width - Identical to Login) ================= */}
        ...
        <div className="lg:col-span-5 flex items-center justify-center p-4 sm:p-8 lg:p-10 relative py-8 my-auto">
          ...
          <motion.div 
            ...
            className="w-full max-w-md bg-white dark:bg-white/[0.04] backdrop-blur-2xl border border-gray-200 dark:border-white/10 rounded-[24px] p-6 sm:p-8 shadow-xl dark:shadow-[0_20px_60px_rgba(0,0,0,0.8)] relative overflow-hidden group hover:border-primary/40 transition-all duration-400 my-auto"
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-4" noValidate>
              ...
              <div className="space-y-1 text-left">
                ...
                <div className="relative group/input">
                  ...
                  <input
                    ...
                    className={`w-full bg-gray-50 dark:bg-black/50 border rounded-xl py-3 pl-10 pr-4 text-sm text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 transition-all duration-300 focus:outline-none ${
              ...
              <div className="space-y-1 text-left">
                ...
                <div className="relative group/input">
                  ...
                  <input
                    ...
                    className={`w-full bg-gray-50 dark:bg-black/50 border rounded-xl py-3 pl-10 pr-10 text-sm text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 transition-all duration-300 focus:outline-none ${
              ...
              <div className="space-y-1 text-left">
                ...
                <div className="relative group/input">
                  ...
                  <input
                    ...
                    className="w-full bg-gray-50 dark:bg-black/50 border border-gray-200 dark:border-white/10 rounded-xl py-3 pl-10 pr-4 text-sm text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 transition-all duration-300 focus:outline-none hover:border-primary/50 focus:border-primary focus:ring-1 focus:ring-primary focus:shadow-yellow-glow uppercase font-mono"
                  />
                </div>
              </div>
              ...
              <div className="space-y-1 pt-1 text-left">
                <label className="flex items-start gap-3 cursor-pointer group">
                  <div className="relative mt-0.5">
                    ...
                    >
                      {formData.agreeTerms && <FiCheck className="text-sm font-black stroke-[3]" />}
                    </div>
                  </div>
              ...
              <button
                ...
                className={`w-full py-3.5 px-6 rounded-xl font-extrabold text-sm uppercase tracking-wider transition-all duration-300 flex items-center justify-center gap-2 shadow-yellow-glow hover:shadow-yellow-glow-lg active:scale-[0.98] mt-2 ${
                  isSuccess
