          ...
          >
            ...
            <div className="flex justify-center">
              ...
              <motion.button
                ...
                whileHover={{ y: -4, scale: 1.02, boxShadow: '0 10px 25px rgba(0, 0, 0, 0.25)', borderColor: 'rgba(255, 193, 7, 0.5)' }}
                whileTap={{ scale: 0.96 }}
                type="button"
                onClick={() => handleSocialSignup('Google')}
                className="w-full flex items-center justify-center gap-2 py-3 px-4 rounded-xl bg-gray-50 dark:bg-white/[0.04] border border-gray-200 dark:border-white/10 hover:bg-gray-100 dark:hover:bg-white/[0.08] transition-all text-xs font-semibold text-gray-800 dark:text-white group"
