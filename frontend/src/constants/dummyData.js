...
export const PRODUCTS = [
    ...
    reviews: [
      {
        ...
        rating: 5,
        comment:
          "Phenomenal device! The battery life easily lasts a day and a half. Titanium build feels extremely premium.",
        date: "2026-06-15",
      },
      {
        id: "r2",
        ...
        rating: 4,
        comment:
          "Camera zoom is amazing, but it gets slightly warm when playing high-end games.",
        date: "2026-07-02",
      },
    ],
  },
  {
    ...
    description:
      "Industry-leading noise cancelling wireless headphones with dual processor control, 8 microphones, and Auto NC Optimizer.",
    brand: "Sony",
    ...
    reviews: [
      {
        ...
        rating: 5,
        comment:
          "Best noise-cancelling headphones on the planet. Block out aircraft engines perfectly!",
        date: "2026-05-18",
      },
    ],
  },
  {
    ...
    description:
      "The ultimate pro laptop. With an 8-core CPU and 10-core GPU, the M3 chip makes editing high-res photos and rendering 4K video exceptionally fast.",
    brand: "Apple",
    category: "laptops",
    price: 349900,
    mrp: 379900,
    ...
    reviews: [
      {
        ...
        rating: 5,
        comment:
          "The speed is unbelievable. Compiled my complex codebase in seconds. Liquid Retina display is gorgeous.",
        date: "2026-06-29",
      },
    ],
  },
    ...
    reviews: [
      {
        ...
        user: "Siddharth Goel",
        rating: 4,
        comment: "Very comfortable for daily walking. Fits true to size.",
        date: "2026-07-08",
      },
    ],
  },
  {
    ...
    description:
      "The XPS 15 laptop is the perfect balance of size and performance to fuel your creative projects. Experience studio-quality sound.",
    brand: "Dell",
    category: "laptops",
    price: 264999,
    mrp: 299999,
  ...
  },
  {
    ...
    description:
      "Welcome to the era of mobile AI. With Galaxy S24 Ultra in your hands, you can unleash whole new levels of creativity and productivity.",
    brand: "Samsung",
    category: "mobiles",
    price: 129999,
    mrp: 139999,
    ...
    reviews: [
      {
        ...
        rating: 5,
        comment:
          "AI search features are very helpful! 200MP camera is out of this world.",
        date: "2026-04-12",
      },
    ],
  },
  ...
  },
  {
    ...
    description:
      "Feel the epic energy in the new Ultraboost Light, our lightest Ultraboost ever. The magic lies in the Light BOOST midsole.",
    brand: "Adidas",
    category: "sports",
    price: 18999,
    mrp: 19999,
...
export const COUPONS = [
  {
    ...
    discountPercent: 20,
    minCartValue: 5000,
    description: "20% Off on purchases above ₹5,000",
  },
  {
    code: "FLASH50",
    discountPercent: 50,
    minCartValue: 15000,
    description: "50% Off (Max ₹10,000 discount)",
  },
  {
    code: "FREESHIP",
    discountPercent: 100,
    minCartValue: 1000,
    description: "Free Shipping (Mock discount worth ₹150)",
  },
];
...
export const TESTIMONIALS = [
  {
    ...
    role: "Premium Buyer",
    comment:
      "NexCart offers a faster, more beautiful layout than anything I have seen. Shopping feels premium here.",
    rating: 5,
    avatar:
  ...
  },
  {
    ...
    comment:
      "Outstanding checkout speeds and crisp details about product specs. The dark UI is absolute eye candy!",
    rating: 5,
    avatar:
  ...
  },
  {
    ...
    comment:
      "Amazing selection of Nike and Adidas sneakers. Prompt notifications and trackable shipping.",
    rating: 4,
    avatar:
